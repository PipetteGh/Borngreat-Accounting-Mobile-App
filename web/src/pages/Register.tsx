...
export default function Register() {
  ...
  useEffect(() => {
    document.title = 'Create Account | Borngreat Accounting - Free Personal Finance';
    const meta = document.querySelector('meta[name="description"]');
    if (meta) {
      meta.setAttribute('content', 'Create your free Borngreat Accounting account. Start tracking income, managing expenses, and building budgets with professional financial tools.');
    }
  }, []);
  ...
  return (
    <Card className="border-none shadow-none bg-transparent mx-auto relative font-outfit">
      ...
      <div className="flex flex-col items-center mb-6">
         ...
         <h1 className="text-2xl font-black text-[#1B1B2F] mb-1 tracking-tighter uppercase font-outfit">Create Account</h1>
         <p className="text-[#8E92A8] text-[10px] font-black uppercase tracking-[0.2em] opacity-60 font-outfit">Borngreat Accounting</p>
      </div>

      <form onSubmit={handleRegister}>
        <CardContent className="grid gap-3 px-0 py-0">
        ...
        <CardFooter className="flex flex-col gap-3 px-0 pb-0 pt-5">
          <Button 
            type="submit" 
            disabled={loading} 
          ...
          <div className="text-center text-base font-medium text-[#8E92A8] font-outfit">
            ...
            <Link to="/login" className="text-accentPurple font-black hover:underline ml-1">
              Login
            </Link>
          </div>
        </CardFooter>
